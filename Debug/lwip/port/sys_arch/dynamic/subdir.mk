...
lwip/port/sys_arch/dynamic/%.o: ../lwip/port/sys_arch/dynamic/%.c lwip/port/sys_arch/dynamic/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lwip-2f-port-2f-sys_arch-2f-dynamic

clean-lwip-2f-port-2f-sys_arch-2f-dynamic:
	-$(RM) ./lwip/port/sys_arch/dynamic/sys_arch.d ./lwip/port/sys_arch/dynamic/sys_arch.o

.PHONY: clean-lwip-2f-port-2f-sys_arch-2f-dynamic
