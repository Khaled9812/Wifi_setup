...
sdmmc/common/%.o: ../sdmmc/common/%.c sdmmc/common/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-sdmmc-2f-common

clean-sdmmc-2f-common:
	-$(RM) ./sdmmc/common/fsl_sdmmc_common.d ./sdmmc/common/fsl_sdmmc_common.o

.PHONY: clean-sdmmc-2f-common
