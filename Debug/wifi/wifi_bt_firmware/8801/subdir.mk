...
wifi/wifi_bt_firmware/8801/%.o: ../wifi/wifi_bt_firmware/8801/%.c wifi/wifi_bt_firmware/8801/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-wifi-2f-wifi_bt_firmware-2f-8801

clean-wifi-2f-wifi_bt_firmware-2f-8801:
	-$(RM) ./wifi/wifi_bt_firmware/8801/8801_cpu1.d ./wifi/wifi_bt_firmware/8801/8801_cpu1.o

.PHONY: clean-wifi-2f-wifi_bt_firmware-2f-8801
