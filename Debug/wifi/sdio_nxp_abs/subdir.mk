...
C_DEPS += \
./wifi/sdio_nxp_abs/fwdnld_sdio.d \
./wifi/sdio_nxp_abs/mlan_sdio.d 

OBJS += \
./wifi/sdio_nxp_abs/fwdnld_sdio.o \
./wifi/sdio_nxp_abs/mlan_sdio.o 


# Each subdirectory must supply rules for building sources it contributes
wifi/sdio_nxp_abs/%.o: ../wifi/sdio_nxp_abs/%.c wifi/sdio_nxp_abs/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-wifi-2f-sdio_nxp_abs

clean-wifi-2f-sdio_nxp_abs:
	-$(RM) ./wifi/sdio_nxp_abs/fwdnld_sdio.d ./wifi/sdio_nxp_abs/fwdnld_sdio.o ./wifi/sdio_nxp_abs/mlan_sdio.d ./wifi/sdio_nxp_abs/mlan_sdio.o

.PHONY: clean-wifi-2f-sdio_nxp_abs
