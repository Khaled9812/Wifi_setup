...
C_DEPS += \
./wifi/firmware_dnld/firmware_dnld.d 

OBJS += \
./wifi/firmware_dnld/firmware_dnld.o 


# Each subdirectory must supply rules for building sources it contributes
wifi/firmware_dnld/%.o: ../wifi/firmware_dnld/%.c wifi/firmware_dnld/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-wifi-2f-firmware_dnld

clean-wifi-2f-firmware_dnld:
	-$(RM) ./wifi/firmware_dnld/firmware_dnld.d ./wifi/firmware_dnld/firmware_dnld.o

.PHONY: clean-wifi-2f-firmware_dnld
