...
C_DEPS += \
./wifi/port/net/net.d \
./wifi/port/net/wifi_netif.d 

OBJS += \
./wifi/port/net/net.o \
./wifi/port/net/wifi_netif.o 


# Each subdirectory must supply rules for building sources it contributes
wifi/port/net/%.o: ../wifi/port/net/%.c wifi/port/net/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-wifi-2f-port-2f-net

clean-wifi-2f-port-2f-net:
	-$(RM) ./wifi/port/net/net.d ./wifi/port/net/net.o ./wifi/port/net/wifi_netif.d ./wifi/port/net/wifi_netif.o

.PHONY: clean-wifi-2f-port-2f-net
